@TestOn('vm')
library wad_score_entry_widget_test;

import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:stroke_stakes/features/score_calculation/widgets/wad_score_entry_widget.dart';
...
void main() {
  testWidgets(
      'WadScoreEntryWidget increments and decrements wad count correctly',
      (WidgetTester tester) async {
    // Initialize the required dependencies for the test
    final List<PlayerScore> playerScores = [
      PlayerScore(
          name:
              'Player 1'), // Use the correct constructor with only the 'name' parameter
